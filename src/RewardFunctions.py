...
class DoubleStateReward:
    def __init__(self, R_max, n_actions, greed_longevity): 
        self.R_max = R_max 
        self.n_actions = n_actions 
    ...
    def __call__(self, s, a, t): 
        if s==0: #not hungry 
            if a==0: #buys nothing
                ...
                return greed(t,self.c)*self.R_max*Phi(lambda t: sawtooth(t,self.n_actions), t, a) #just need to check this is right with actions-1
        else: #hungry
            if a == 0: 
