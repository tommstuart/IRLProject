...
class DoubleStateSpace(gym.Env): 
    def __init__(self, n_actions, discount_rate, satiated_prob = 0.5, hunger_prob = 0.5, R_max=5): 
        #I think I need to call __init__ on the super class 
        self.reward = SingleStateReward(R_max = R_max, n_actions = n_actions) 
        self.R_max = R_max 
        self.discount_rate = discount_rate 
        ...
        for s in self.states: 
            for a in self.actions: 
                for s_ in self.states:
                    ...
                    if (s,s_) == (0,0):
                        if a == 0:
                            self.P[s,a,s_] = 1 - self.hunger_prob 
                        else:
                            self.P[s,a,s_] = 1
                    #Going from not hungry -> hungry 
                    elif (s,s_) == (0,1): 
                        if a == 0: 
                            self.P[s,a,s_] = self.hunger_prob 
                        else: 
                            self.P[s,a,s_] = 0
                    #Going from hungry -> not hungry 
                        ...
                        if a == 0: 
                            ...
                            self.P[s,a,s_] = self.satiated_prob
                    #Going from hungry -> hungry 
                    else:
                        if a == 0: 
                            self.P[s,a,s_] = 1                            
                        else: 
                            self.P[s,a,s_] = 1 - self.satiated_prob 
